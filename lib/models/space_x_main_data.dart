...
//
//     final spaceXAllDataModel = spaceXAllDataModelFromJson(jsonString);

import 'dart:convert';

SpaceXAllDataModel spaceXAllDataModelFromJson(String str) => SpaceXAllDataModel.fromJson(json.decode(str));

String spaceXAllDataModelToJson(SpaceXAllDataModel data) => json.encode(data.toJson());

class SpaceXAllDataModel {
    SpaceXAllDataModel({
        this.fairings,
        this.links,
    ...
    factory SpaceXAllDataModel.fromJson(Map<String, dynamic> json) => SpaceXAllDataModel(
        ...
        capsules: json["capsules"] == null ? null : List<dynamic>.from(json["capsules"].map((x) => x)),
        ...
        failures: json["failures"] == null ? null : List<dynamic>.from(json["failures"].map((x) => x)),
        ...
        datePrecision: json["date_precision"] == null ? null : json["date_precision"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "capsules": capsules == null ? null : List<dynamic>.from(capsules!.map((x) => x)),
        "payloads": payloads == null ? null : List<dynamic>.from(payloads!.map((x) => x)),
        ...
        "failures": failures == null ? null : List<dynamic>.from(failures!.map((x) => x)),
...
class Flickr {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "original": original == null ? null : List<dynamic>.from(original!.map((x) => x)),
    };
}
